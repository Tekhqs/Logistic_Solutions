...
namespace DAL
{
    ...
    public partial class LogisticSolutionDevDBEntities : DbContext
    {
        public LogisticSolutionDevDBEntities()
            : base("name=LogisticSolutionDevDBEntities")
        {
        }
        ...
        public virtual DbSet<tblCustomerShippingAccount> tblCustomerShippingAccounts { get; set; }
        ...
        public virtual DbSet<tblSecurityGroupTask> tblSecurityGroupTasks { get; set; }
        public virtual DbSet<tblSecurityTask> tblSecurityTasks { get; set; }
        public virtual DbSet<tblShippingAddress> tblShippingAddresses { get; set; }
        public virtual DbSet<tblShippingCarrierMaster> tblShippingCarrierMasters { get; set; }
